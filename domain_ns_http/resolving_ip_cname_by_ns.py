...
def query_ip_cname_by_ns (domain, authoritative_ns, local_dns = '1.2.4.8', timeout=3, retry_time=3):
    """
...
if __name__ == '__main__':
    ...
    print query_ip_cname_by_ns ('www.baidu.cn', authoritative_ns='ns3.baidu.com')
    # print query_ip_cname_by_ns ('www.baidu.com', authoritative_ns='dns1.baidu.com')
