...
def restore_file():
    """恢复文件"""
    backup_command = 'mv ./root_zone_data/backup_root.zone ./root_zone_data/root.zone'  # 备份命令
    commands.getstatusoutput(backup_command)  # 备份
...
def root_zone_download():
    ...
    url = 'ftp://rs.internic.net/domain/root.zone'  # 远程文件地址
